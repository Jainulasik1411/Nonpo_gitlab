...
public class Nonpo_Process_BranchFlow123 extends BaseClass {
	...
	private void LoginFunctionality() throws InterruptedException, AWTException, IOException {
		...
		driver.findElement(By.xpath("//*[text()='Reimbursement or Other Claims']")).click();
		wait(1000);
		...
		driver.findElement(By.xpath("//span[contains(text(), '100198') and contains(text(), 'The Global Economics Limited')]")).click();
		thread();
		...
		WebElement element = driver.findElement(By.xpath("//*[text()='MMK']"));
		...
		driver.findElement(By.xpath("//*[text()='ATM House cost']")).click();
		wait(2000);
		...
		inputareasindex(driver, 1, "7");
		
		threadhalf();
		

		driver.findElement(By.xpath("(//*[@autocomplete='off'])[1]/following::input[@autocomplete='off'][1]")).click();
		...
		driver.findElement(By.xpath("//*[text()='Plastic Card Expenses']")).click();
		wait(2000);
