...
public class Nonpo_Process_Functional_Withdraw_deny_Reject_Flow2 extends BaseClass {
	...
	private void LaunchBrowser() throws IOException, AWTException, InterruptedException {
		...
		driver.findElement(By.xpath("//span[contains(text(), '100147') and contains(text(), 'SAP System Application & Products A')]")).click();
		thread();
		...
		buttonClick(jhgf);
		wait(100);
		jhgf.sendKeys("fuction_npo@gmail.com");
		...
		try {
			kjhg.sendKeys("JS2!fjq#v~$RiHb1OcV~");
		} catch (StaleElementReferenceException e) {
		}
		...
		buttonClick(vcx);
		wait(100);
		vcx.sendKeys("fuction_npo@gmail.com");
		...
		try {
			jhgfd.sendKeys("JS2!fjq#v~$RiHb1OcV~");
		} catch (StaleElementReferenceException e) {
		}
		...
		WebElement fyu = driver.findElement(By.xpath("//*[text()='Login']"));
		wait(100);
		buttonClick(fyu);
